...
const zh = {
  ...
  events: { heading: "活动预告", empty: "暂时没有排期，欢迎订阅邮件以获取更新。" },
  resources: { heading: "学习资源", blurb: "入门资料、参考书目与工作坊讲义。以下为示例，欢迎通过表单补充建议。" },
...
const sampleEvents = [
  {
    ...
    tags: ["Seminar", "Social"],
    blurb:
      "A welcoming session to introduce Nüshu for the semester, including an overview, practice, and social time.",
  },
  {
