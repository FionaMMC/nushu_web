  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f8f7f5] to-white text-gray-900">
      ...
      <section id="events" className="py-20">
        <div className="mx-auto w-full max-w-6xl px-6">
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-8">{t.events.heading}</h2>
      ...
      <section id="resources" className="py-20">
        <div className="mx-auto w-full max-w-6xl px-6">
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-8">{t.resources.heading}</h2>
      ...
      <section id="gallery" className="py-20">
        <div className="mx-auto w-full max-w-6xl px-6">
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-8">{t.gallery.heading}</h2>
      ...
      <section id="join" className="py-20">
        <div className="mx-auto w-full max-w-6xl px-6">
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight mb-8">{t.join.heading}</h2>
